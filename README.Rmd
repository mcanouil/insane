...
gif_app <- gifski(
  png_files = list.files(dirname(knitr::opts_chunk$get("fig.path")), pattern = "app_", full.names = TRUE), 
  gif_file = paste0(knitr::opts_chunk$get("fig.path"), "app.gif"), 
  width = 1920*0.75, height = 1080*0.75,
  delay = 2, 
  loop = TRUE, 
  progress = FALSE
)
knitr::include_graphics(gif_app)
```
...
```{r, echo = FALSE}
gif_template <- gifski(
  png_files = list.files(dirname(knitr::opts_chunk$get("fig.path")), pattern = "template_", full.names = TRUE), 
...
knitr::include_graphics(gif_template)
```
...
```{r, echo = FALSE}
knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_003.png"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_004.png"))
```
...
* Using all experiments in the selected project
    ...
    * Histogram version
        ...
        knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_005.png"))
        ```

    * Boxplot version
        ```{r, echo = FALSE, out.width = "50%"}
        knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_007.png"))
        ```

* Using some of the experiments in the selected project
      ```{r, echo = FALSE, out.width = "50%"}
      knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_008.png"))
      ```
...
```{r, echo = FALSE}
knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_006.png"))
```
...
```{r, echo = FALSE}
knitr::include_graphics(file.path(dirname(knitr::opts_chunk$get("fig.path")), "app_010.png"))
```
