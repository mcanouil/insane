...
### Excel Template ([top](#overview)) {#template}
...
#### Technical Quality-Control ([top](#overview)) {#qc}
...
#### Statistical analyses ([top](#overview)) {#stats}
...
#### List of Outliers (Issues Detected) ([top](#overview)) {#outliers}
